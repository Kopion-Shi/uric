...
#     git_release_commit_id = models.CharField(max_length=255,verbose_name='git_commit_id',null=True,blank=True)
#
#     release_status = models.IntegerField(choices=release_status_choices, default=1, verbose_name='状态')
#     user = models.ForeignKey(User, verbose_name='申请人', on_delete=models.CASCADE, related_name='release_apply_user',db_constraint = False)
#
#     class Meta:
